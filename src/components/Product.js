    ...
    return (
        <Card key={product.key} sx={{ maxWidth: 345 , margin: 5, minWidth: 345}}>
            ...
            <CardContent>
                ...
                <span style={{cursor:'pointer'}} onClick={() => {navigate('/products/' + product.key)}}>{product.name}</span>
            ...
            <CardActions>
                <Button size="medium" variant="contained" onClick={() => {navigate('/products/' + product.key)}}>Buy</Button>
